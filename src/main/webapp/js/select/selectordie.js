        ...
        var _private = {
                ...
                return this.each(function (i) {
                    ...
                    if ( !$(this).parent().hasClass("sod_select") ) {
                        ...
                        if ( $settingsPlaceholder && !$settingsPrefix ) {
                            $sodHtml += "<div class=\"sod_label sod_placeholder\">" + $settingsPlaceholder + "</div>";
                        } else {
                        ...
                        if ( $settingsSize ) {
                            ...
                            $sodList.css({"max-height": $sodHeight });
                        	 ...
                        	 $sodListWrapper.show();
                        	$sodListWrapper.removeAttr("style");
                            $sodList.css({"max-height": "255px" });//通过参数里的size配置的话，会出现有下拉列表数据,但高度为1的bug
                        }
            ...
            populateSoD: function ($option, $sodList, $sod) {
                var $sodPlaceholder     = $sod.data("placeholder"),
                    ...
                    $optionSearch       = $option.data("search"),
                ...
                if ( $option.is("option") ) { // If <option>
                	//添加中文快搜的功能，使用中文的首字母可快速定位中文列表的位置
                	if($optionSearch == undefined){
                		$optionSearch = getGameSearchChars($optionText);//注意这里的方法依赖common.js
                	}
                    $("<li/>", {
            ...
            keyboardUse: function (e) {
                ...
                if ( e.which !== 0 && e.charCode !== 0 ) {
                    ...
                    $sodFilterHit = $sodOptions.filter(function() {
                        ...
                        return searchStr.toLowerCase().indexOf($sod.data("filter").toLowerCase()) === 0;
            ...
            blurSod: function ($sod) {
                if ( $("body").find($sod).length ) {
                    ...
                    if ( !$optionActive.hasClass("selected") ) {
                    	if($sod.find(".sod_label").get(0).lastChild){
