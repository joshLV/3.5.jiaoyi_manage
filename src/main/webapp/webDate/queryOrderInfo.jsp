...
<%
    ...
    try{
	String  sellUid =  request.getParameter("order_sell_uid");
	String  btime =  request.getParameter("btime");
	String  etime =  request.getParameter("etime");
    //加密key
    String encodeKey = request.getParameter("encodeKey");
    String md5key = MD5.encode(sellUid+"sereblwerijwerie");
    ...
    if(null == sellUid || null == btime || null == etime){
    	json.put("result", "1");
    	json.put("msg", "参数为空");
		out.println(json);
	...
	List<Orders> o = oService.queryOrderBySellUid(Integer.parseInt(sellUid), btime, etime);
    String s = "";
	if(null == o){
		json.put("result", "1");
		json.put("msg", "该卖家用户不存在订单");
		out.println(json);
	    System.out.println(json);
	    return;
	}
