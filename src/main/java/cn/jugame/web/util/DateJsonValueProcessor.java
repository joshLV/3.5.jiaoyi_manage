...
public class DateJsonValueProcessor implements JsonValueProcessor{
    ...
    public DateJsonValueProcessor(String datePattern) {
        try {
            dateFormat = new java.text.SimpleDateFormat(datePattern);
        } catch (Exception e) {
            dateFormat = new java.text.SimpleDateFormat(Default_DATE_PATTERN); 
        }
    }
     ...
     */
    @Override
    public Object processArrayValue(Object value, net.sf.json.JsonConfig jsonConfig) {
     ...
     */
    @Override
    public Object processObjectValue(String key, Object value,net.sf.json.JsonConfig jsonConfig) {
        return process(value);
    }
