...
public interface OnlineCustomerMonitorService {
	 ...
	 */
	PageInfo<WorkRateForm> queryWorkRatePageInfo(Map<String, Object> conditions, int pageSize, int pageNo, String sort,
			String order);
	 ...
	 * @return
	 */
	List<CustomerStatusLog> queryTodayStatusLog(int customerId, Date onDutyTime, Date offDutyTime);
	 ...
	 * @return 影响记录数
	 */
	int modifyWorkStatusCategory(int categoryID, String categoryName, int categoryWeight);
	 ...
	 * @return 返回PageInfo类型的工作状态类型
	 */
	PageInfo<WorkStatus> queryCategoryList(int pageSize, int pageNo, String sort, String order);
	...
	/**
	 * 所有在线客服 
	 * @param type 0 所有 1 客服 2 物服  3 投咨/app投资
	 * @return
	 */
	List<SysUserinfo> onDutyCustomer(int type);
	 ...
	 * @return 
	 */
	boolean onDutyCustomerDuty(List<SysUserinfo> list,int uid);
}
